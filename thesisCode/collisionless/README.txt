This directory contains code to simulate a collisionless plasma. The two directories are used to simulate the code in single and double precision.

#########DIRECTORY STRUCTURE
-double: double-precision version of the collisionless simulation

-single: single-precision version of the collisionless simulation
